...
func (c *CodeCache) Verify(ctx context.Context, biz, phone, expeditedCode string) error {
...
func (c *CodeCache) key(biz, phone string) string { return fmt.Sprintf("phone_code:%s,%s", biz, phone) }
